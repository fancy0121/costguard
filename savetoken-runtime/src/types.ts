export type SaveTokenTier = "sol" | "terra" | "execution" | "glm-backup";

export type SaveTokenTaskSignals = {
  text: string;
  filesChanged?: number;
...
export type SaveTokenRouteDecision = {
  tier: SaveTokenTier;
  candidates: string[];
...
export type ResponsesRequest = {
  ...
  savetokenTask?: string;
  savetokenTier?: SaveTokenTier;
  savetokenRoute?: string;
};
...
export type RouteAdmissionEvidence = {
  decidedAt: string;
  decidingTier: SaveTokenTier;
  requestedTier?: SaveTokenTier;
  selectedProviderTier?: SaveTokenTier;
  escalationReasons: string[];
