...
export function isTierAllowed(taskTier: SaveTokenTier, candidateTier: SaveTokenTier): boolean {
...
export function decideRoute(signals: SaveTokenTaskSignals): SaveTokenRouteDecision {
