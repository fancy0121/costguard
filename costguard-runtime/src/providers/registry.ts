...
export type ProviderDescriptor = {
  ...
  modelTiers?: Readonly<Record<string, CostGuardTier>>;
...
export class ProviderRegistry {
  ...
  tierFor(requestedModel: string): CostGuardTier | undefined {
...
export async function invokeWithFailover(
  ...
  routes: string[],
  input: Omit<ProviderInvocationRequest, "requestedModel"> & { tier: CostGuardTier },
