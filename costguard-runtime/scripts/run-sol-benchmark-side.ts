...
const fixturePath = join(root, "docs", "superpowers", "evidence", "costguard-quality-token-benchmark-fixtures-v2-2026-08-24.json");
const manifestPath = join(root, "docs", "superpowers", "evidence", "costguard-quality-token-benchmark-instrument-v2-2026-08-24.json");
...
const outPath = join(root, "docs", "superpowers", "evidence", `costguard-quality-token-benchmark-${model.replace(/[^A-Za-z0-9._-]+/g, "-")}-${date}.json`);
